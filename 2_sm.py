...
def check_status():
    status = 0
    f_status = open('/home/mpiscil/cloud2/Yulia/QW_send_formulas/Status2.txt', 'r')
    while status == 0:
        time.sleep(0.1)
...
def get_formulas():
    f = open('/home/mpiscil/cloud2/Yulia/QW_send_formulas/Formulas2.txt', 'r')
    try:
...
def write_losses(n_individs, results):
    f_write = open('/home/mpiscil/cloud2/Yulia/QW_send_formulas/Losses2.txt', 'w')
    try:
...
def main():
    ...
    log_filename = '/home/mpiscil/cloud2/Yulia/QW_send_formulas/Log_python2.txt'
    ...
    for general in range(num_generals):
        ...
        f_status = open('/home/mpiscil/cloud2/Yulia/QW_send_formulas/Status2.txt', 'w')
        f_status.write('0')
        f_status.close()
