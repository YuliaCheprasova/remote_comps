...
from models.simpleCIFAR import *
...
def check_status():
    status = 0
    f_status = open('C:\\Programs\\remote_comps\\gp_with_neural_network_linux\\Status1.txt', 'r')
    while status == 0:
        time.sleep(0.1)
...
def get_lrs():
    f = open('C:\\Programs\\remote_comps\\gp_with_neural_network_linux\\Lrs1.txt', 'r')
    try:
        lines = f.readlines()
...
def write_losses(n_individs, results):
    f_write = open('C:\\Programs\\remote_comps\\gp_with_neural_network_linux\\Losses1.txt', 'w')
    try:
...
def main():
    #parallel = True
    log_filename = 'C:\\Programs\\remote_comps\\gp_with_neural_network_linux\\Log_python1.txt'
    ...
    for general in range(num_generals):
        ...
        f_status = open('C:\\Programs\\remote_comps\\gp_with_neural_network_linux\\Status1.txt', 'w')
        f_status.write('0')
        f_status.close()
