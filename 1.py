...
def main():
    parallel = True
    if parallel:
        f_log = open('/home/mpiscil/cloud2/Yulia/gp_with_neural_network/Log_python1.txt', 'w', buffering=1)
    print('start Python')
    if parallel:
    ...
    if parallel:#тут удалить можно
        for general in range(num_generals):
            ...
            start = time.time()
            status = 0
            f_status = open('/home/mpiscil/cloud2/Yulia/gp_with_neural_network/Status1.txt', 'r')
            while status == 0:
                time.sleep(0.1)
            ...
            f_write = open('/home/mpiscil/cloud2/Yulia/gp_with_neural_network/Losses1.txt', 'w')
            ...
            f_status = open('/home/mpiscil/cloud2/Yulia/gp_with_neural_network/Status1.txt', 'w')
            f_status.write('0')
            f_status.close()
        ...
        start = time.time()
        f = open('C:/Programs/Disk_C/CodeBlocks_projects/gp_with_neural_network/Lrs1.txt', 'r')
        # f = open('C:/Programs/Disk_C/My projects/genetic_programming_with_nn/genetic_programming_with_nn/Lrs.txt', 'r')
        try:
            lines = f.readlines()
            n_individs = len(lines)
        ...
        print("Открытие файла для записи losses")
        f_write = open('C:/Programs/Disk_C/CodeBlocks_projects/gp_with_neural_network/Losses1.txt', 'w')
        # f_write = open('C:/Programs/Disk_C/My projects/genetic_programming_with_nn/genetic_programming_with_nn/Losses.txt', 'w')
        try:
            for i in range(n_individs):
                f_write.write(f"{results[i]:.8f}\n")
